...
![图片大小使用示例 =200x300](http://markdown.xiaoshujiang.com/img/avatar_d_white_bg_256x256.png)

![只指定宽度的图片大小使用示例 =200x](http://markdown.xiaoshujiang.com/img/avatar_d_white_bg_256x256.png)

![只指定高度的图片大小使用示例 =x100](http://markdown.xiaoshujiang.com/img/avatar_d_white_bg_256x256.png)
