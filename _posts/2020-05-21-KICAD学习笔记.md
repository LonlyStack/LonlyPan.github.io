...
4. 单击顶部工具栏上的 页面设置 图标 ![enter description here](https://LonlyPan.github.io/images/Posts/2020-05-21-KICAD学习笔记/sheetset.png)。 设置适当的 `纸张尺寸`（'A4'，'8.5x11’等）并输入标题为 `test1` 。 如有必要，您将在此处看到可以输入更多信息， 此信息将填充右下角的原理图信息表，使用鼠标滚轮放大查看。单击确定，退出页面设置。保存整个原理图：文件 → 保存
